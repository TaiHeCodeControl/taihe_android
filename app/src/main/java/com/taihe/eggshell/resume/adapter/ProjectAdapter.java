...
import com.taihe.eggshell.resume.ResumeProjectActivity;
...
public class ProjectAdapter extends BaseAdapter{
    ...
    public ProjectAdapter(Context context,List<ResumeData> list,Resumes resumes,Handler handlers){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final ResumeData project = worklists.get(position);

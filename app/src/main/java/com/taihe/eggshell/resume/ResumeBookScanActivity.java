...
public class ResumeBookScanActivity extends BaseActivity{
    ...
    private TextView companyTextView,departTextView,contextTextView,workTimeStart;
    private String companyName,startTime,positionName,contextWord;
    private Resumes eid;
    @Override
    ...
    public void initData() {
        ...
        departTextView.setText(positionName);
        contextTextView.setText(contextWord);
        workTimeStart.setText(startTime);
    }
